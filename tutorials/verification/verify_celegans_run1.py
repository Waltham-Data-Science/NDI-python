...
def main():
    ...
    subjectTable = show("docTable.subject", lambda: fdt.subject(sess))
    ...
    def _stackall():
        ...
        print(f"  StackAll -> {len(tables)} table(s); shapes {[t.shape for t in tables]}", flush=True)
