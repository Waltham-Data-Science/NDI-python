...
Symmetry tests verify that NDI-python and NDI-matlab produce identical artifacts.
...
Tests that cannot find their expected artifact directory are **skipped** (not
