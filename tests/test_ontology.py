"""Tests for ndi.ontology — ontology lookup system with providers."""
...
class TestLookup:
    ...
    def test_cache_hit(self):
        from ndi.ontology import OntologyResult, _lookup_cache, lookup
    ...
    def test_cache_eviction(self):
        from ndi.ontology import _CACHE_MAX, OntologyResult, _lookup_cache, lookup
    ...
    def test_case_insensitive_prefix(self):
        ...
        from ndi.ontology import OntologyResult, lookup
