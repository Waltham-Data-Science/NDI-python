"""Read and verify symmetry artifacts for a blank kjnielsenlab NDI session.

Python equivalent of:
    tests/+ndi/+symmetry/+readArtifacts/+session/blankSessionKjnielsenlab.m
...
class TestBlankSessionKjnielsenlab:
    """Mirror of ndi.symmetry.readArtifacts.session.blankSessionKjnielsenlab."""
    ...
    def test_blank_session_kjnielsenlab_summary(self, source_type):
        ...
        # Normalize DAQ system ordering — the database may return them in
        # different order on re-open.
    ...
    def test_blank_session_kjnielsenlab_metadata_reader_file_parameters(self, source_type):
    ...
    def test_blank_session_kjnielsenlab_sync_rules_installed(self, source_type):
    ...
    def test_blank_session_kjnielsenlab_metadata_readers_agree_across_languages(self):
    ...
    def test_blank_session_kjnielsenlab_sync_rules_agree_across_languages(self):
