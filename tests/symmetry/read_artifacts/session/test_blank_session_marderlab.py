"""Read and verify symmetry artifacts for a blank marderlab NDI session.

Python equivalent of:
    tests/+ndi/+symmetry/+readArtifacts/+session/blankSessionMarderlab.m
...
class TestBlankSessionMarderlab:
    """Mirror of ndi.symmetry.readArtifacts.session.blankSessionMarderlab."""
    ...
    def test_blank_session_marderlab_summary(self, source_type):
    ...
    def test_blank_session_marderlab_metadata_reader_file_parameters(self, source_type):
    ...
    def test_blank_session_marderlab_sync_rules_installed(self, source_type):
    ...
    def test_blank_session_marderlab_metadata_readers_agree_across_languages(self):
    ...
    def test_blank_session_marderlab_sync_rules_agree_across_languages(self):
