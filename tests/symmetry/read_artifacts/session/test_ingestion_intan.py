"""Read and verify symmetry artifacts for an ingested Intan session.

Python equivalent of:
    tests/+ndi/+symmetry/+readArtifacts/+session/ingestionIntan.m
...
class TestIngestionIntan:
    """Mirror of ndi.symmetry.readArtifacts.session.ingestionIntan."""
    ...
    def test_ingestion_intan_summary(self, source_type):
    ...
    def test_ingestion_intan_documents(self, source_type):
