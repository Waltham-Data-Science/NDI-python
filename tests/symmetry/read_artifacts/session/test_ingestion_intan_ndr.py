"""Read and verify symmetry artifacts for an ingested Intan NDR session.

Python equivalent of:
    tests/+ndi/+symmetry/+readArtifacts/+session/ingestionIntanNDR.m
...
class TestIngestionIntanNDR:
    """Mirror of ndi.symmetry.readArtifacts.session.ingestionIntanNDR."""
    ...
    def test_ingestion_intan_ndr_summary(self, source_type):
    ...
    def test_ingestion_intan_ndr_documents(self, source_type):
