"""Shared helper for creating blank lab sessions in symmetry tests.
...
This mirrors the MATLAB ``ndi.setup.lab()`` function.
"""
...
def setup_lab_daq_systems(session, lab_name: str) -> None:
    ...
    This is the Python equivalent of MATLAB's ``ndi.setup.lab(lab_name, ...)``.
    """
