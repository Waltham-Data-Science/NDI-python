...
class TestDocumentClass:
    ...
    def test_doc_isa_true(self):
        ...
        doc = Document(props)
        assert doc.doc_isa('ndi_element') == True
    ...
    def test_doc_isa_false(self):
        ...
        doc = Document(props)
        assert doc.doc_isa('ndi_probe') == False
...
class TestDocumentDependencies:
    ...
    def test_set_dependency_value(self):
        ...
        props = {
            ...
            'document_class': {'class_name': 'base', 'superclasses': []},
            'depends_on': [
                {'name': 'session_id', 'value': 'old_value'}
            ]
        }
        doc = Document(props)
...
class TestDocumentStaticMethods:
    ...
    def test_find_doc_by_id_found(self):
        ...
        docs = [
            Document({'base': {'id': 'id1', 'datestamp': '', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
            Document({'base': {'id': 'id2', 'datestamp': '', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
            Document({'base': {'id': 'id3', 'datestamp': '', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
        ]
    ...
    def test_find_newest(self):
        ...
        docs = [
            Document({'base': {'id': 'id1', 'datestamp': '2024-01-01T00:00:00.000Z', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
            Document({'base': {'id': 'id2', 'datestamp': '2024-01-03T00:00:00.000Z', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
            Document({'base': {'id': 'id3', 'datestamp': '2024-01-02T00:00:00.000Z', 'session_id': ''}, 'document_class': {'class_name': 'base', 'superclasses': []}}),
        ]
