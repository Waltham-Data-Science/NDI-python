...
class TestEpochProbeMapDAQSystem:
    ...
    def test_construction(self):
        ...
        epm = EpochProbeMapDAQSystem(
            name='probe1', reference=1, type='n-trode',
            devicestring='intan1:ai1-4', subjectstring='mouse001',
        )
    ...
    def test_serialization_struct(self):
        from ndi.epoch.epochprobemap_daqsystem import EpochProbeMapDAQSystem
        epm = EpochProbeMapDAQSystem(
            name='p1', reference=2, type='t',
            devicestring='d:ai1', subjectstring='s',
        )
...
class TestMFDAQEpochChannel:
    ...
    def test_import(self):
        from ndi.file.type.mfdaq_epoch_channel import MFDAQEpochChannel, ChannelInfo
    ...
    def test_channel_group_decoding(self):
        ...
        groups = MFDAQEpochChannel.channel_group_decoding(
