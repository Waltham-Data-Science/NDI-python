...
from ..mfdaq import MFDAQReader, ChannelInfo, standardize_channel_type
...
def _get_extractor_for_file(filepath: str) -> Optional[Any]:
    """
...
class SpikeInterfaceReader(MFDAQReader):
    ...
    def _get_recording(self, epochfiles: List[str]) -> Optional[Any]:
